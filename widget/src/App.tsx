...
const App = () => {
  ...
  const appendedChatHistory: JSX.Element[] = []
    ...
    <div>
        ...
        <div className="z-50 chatbot-widget">
            <div className="fixed bottom-[30px] right-[30px]">
              <div className='w-[350px] absolute rounded-[20px] border-[1px] border-solid border-primary bg-neutral right-0 bottom-[50px] h-[420px]'>
                  <div>
